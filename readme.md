...
3. As a user, I want to select a character for the game. 

4. As a user, I want to move left and right to avoid falling objects. 

5. As a user, I want the game to end when I get hit so that I know I lost. 
...
5) Display status after game is finished Win/Loss  
